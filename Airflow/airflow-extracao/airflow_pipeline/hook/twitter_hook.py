...
class TwitterHook(HttpHook):
    ...
    def create_url(self):
        ...
        tweet_fields = "tweet.fields=author_id, conversation_id, created_at, id_reply_to_user_id, public_metrics, lang, text"
    ...
    def paginate(self, url_raw, session):
        ...
        while "next_token" in json_response.get("meta", {}) and contador < 20:
